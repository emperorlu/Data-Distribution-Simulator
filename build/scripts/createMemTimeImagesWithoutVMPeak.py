...
def draw_img_memtime_no_vmpeak(distri, homogen, extraName="", extraDirName="", tasks=1, hetDiskBase=128):
    path = "../data/mem_time/"
    if homogen:
        path += "homogen/"
    else:
    ...
    imagefile = imagePath + f + "_no_vmpeak"
    disImageFile = disImagePath + f + "_no_vmpeak"
    ...
    if (not os.path.exists(imagefile + ".png")) or (os.path.getmtime(imagefile + ".png") <= os.path.getmtime(path)) or (not os.path.exists(disImageFile + ".png")) or (os.path.getmtime(disImageFile + ".png") <= os.path.getmtime(path)):
        ...
        result = calc_memtime_data(memfiles, speedFiles, imagefile, vmpeak=False)
...
def draw_img_memtime_share_sf_no_vmpeak(homogen, extraDirName="", tasks=1):
    distri = Share
    path = "../data/mem_time/"
    if homogen:
        path += "homogen/"
...
def draw_img_memtime_nn_nc_no_vmpeak(homogen, extraDirName="", tasks=1):
...
def draw_img_memtime_file_no_vmpeak(filedistri, blockdistri, homogen, big, tasks=1):
    path = "../data/mem_time/"
    if homogen:
        path += "homogen/"
    else:
...
if __name__ == "__main__":
    draw_img_memtime_no_vmpeak(NearestNeighbour, True)
    draw_img_memtime_no_vmpeak(Share, True)
    draw_img_memtime_no_vmpeak(Share, True, extraDirName="SF5", extraName="--5sf")
    draw_img_memtime_no_vmpeak(RedundantShare, True)
    draw_img_memtime_no_vmpeak(RedundantShare, True, extraDirName="Improved")
    draw_img_memtime_no_vmpeak(RUSHp, True)
    draw_img_memtime_no_vmpeak(RUSHt, True)
    draw_img_memtime_no_vmpeak(RUSHr, True)
    draw_img_memtime_no_vmpeak(CRUSH, True, extraDirName="l1r1", extraName="--l1r1")
    draw_img_memtime_no_vmpeak(CRUSH, True, extraDirName="l1r2", extraName="--l1r2")
    #draw_img(CRUSH, True, extraDirName="l1r3", extraName="--l1r3")
    draw_img_memtime_no_vmpeak(CRUSH, True, extraDirName="l1r4", extraName="--l1r4")
    draw_img_memtime_no_vmpeak(FastRedundantShare, True)

    draw_img_memtime_no_vmpeak(NearestNeighbour, False)
    draw_img_memtime_no_vmpeak(NearestNeighbour, False, extraDirName="HetCopies", extraName="--HetCopies")
    draw_img_memtime_no_vmpeak(Share, False)
    draw_img_memtime_no_vmpeak(Share, False, extraDirName="SF5", extraName="--5sf")
    draw_img_memtime_no_vmpeak(RedundantShare, False)
    draw_img_memtime_no_vmpeak(RedundantShare, False, extraDirName="Improved")
    draw_img_memtime_no_vmpeak(RUSHp, False)
    draw_img_memtime_no_vmpeak(RUSHt, False)
    draw_img_memtime_no_vmpeak(RUSHr, False)
    #draw_img(CRUSH, False, extraDirName="l1r1", extraName="--l1r1")
    draw_img_memtime_no_vmpeak(CRUSH, False, extraDirName="l1r2", extraName="--l1r2")
    #draw_img(CRUSH, False, extraDirName="l1r3", extraName="--l1r3")
    draw_img_memtime_no_vmpeak(CRUSH, False, extraDirName="l1r4", extraName="--l1r4")
    draw_img_memtime_no_vmpeak(FastRedundantShare, False, hetDiskBase=16)

    draw_img_memtime_nn_nc_no_vmpeak(True, "DiskCopies")
    draw_img_memtime_nn_nc_no_vmpeak(False, "DiskCopies")
    
    draw_img_memtime_share_sf_no_vmpeak(True, "StretchFactor")
    draw_img_memtime_share_sf_no_vmpeak(False, "StretchFactor")

    draw_img_memtime_file_no_vmpeak(RedundantShare, RedundantShare, True, True)
    draw_img_memtime_file_no_vmpeak(RedundantShare, RedundantShare, True, False)
